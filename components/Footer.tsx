        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li><a href="#" className="text-base text-gray-300 hover:text-white">Networking</a></li>
              <li><a href="#" className="text-base text-gray-300 hover:text-white">Exhibitions</a></li>
            </ul>
          </div>
          <div>
